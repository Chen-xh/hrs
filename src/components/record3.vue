      ...
      <div class="record_box" style="position:relative" >
        ...
        <el-table :data="tableData" stripe style="width: 100%;">
          ...
          <el-table-column
            ...
            label="修改">
            <template slot-scope="scope">
              <el-button type="warning" size="mini" @click="update(scope.$index)">修改</el-button>
            </template>
          </el-table-column>
...
import {findAll, findAllNoCheck, getAllOrganization, selectRecord} from "../assets/js/request";
...
export default {
  ...
  methods: {
    ...
    select(){
      selectRecord(this.ol1_option,this.ol2_option,this.ol3_option,this.position_classify_options,this.position_name_options,this.select_time).then((response) => {
        this.tableData = response.data.extended.record;
