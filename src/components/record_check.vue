          ...
          <el-row>
            <el-form-item>
              <el-col :span="2" offset="18">
                <el-button type="primary" @click="submitForm('form')">复核通过</el-button>
              </el-col>
              <el-col :span="2">
          ...
          <el-row>
            <el-col :span="6">
              <el-form-item label="I级机构" prop="lo1">
                <el-input v-model="form.lo1Name" disabled></el-input>

              </el-form-item>
            </el-col>
            <el-col :span="6">
              <el-form-item label="II级机构" prop="lo2">
                <el-input v-model="form.lo2Name" disabled></el-input>

              </el-form-item>
            </el-col>
            <el-col :span="6">
              <el-form-item label="III级机构" prop="lo3">
                <el-input v-model="form.lo3Name" disabled></el-input>
...
<script>
import {findSalaryStandardChecked, getAllOrganization, serverUrl} from '../assets/js/request.js';
import {
  nationality,
  ethnic,
...
import {updateRecord} from "../assets/js/request";
  ...
  methods: {
    ...
    submitForm(formName) {
      this.$refs[formName].validate((valid) => {
        if (valid) {
          updateRecord(this.form, this.file);
          this.back();
        } else {
          return false;
        }
